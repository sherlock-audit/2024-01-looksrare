...
import {AmountInvalid, LengthsInvalid} from "@looksrare/contracts-transfer-manager/contracts/errors/SharedErrors.sol";

// Enums
import {TokenType} from "@looksrare/contracts-transfer-manager/contracts/enums/TokenType.sol";

// NOTE: This contract is exactly the same as the one in @looksrare/contracts-transfer-manager, except this is running on 0.8.23.
//       The contract was deployed with 0.8.20, so it's better to not change the contract version in @looksare/contracts-transfer-manager.
